...
<header class="header">
  <div class="container nav">
    <a href="index.html" class="logo" aria-label="Ataevler Hurda Metal ana sayfa">
      <span style="display:flex;align-items:center;gap:10px;font-weight:800;font-size:1.3rem;color:#0c2a4d">
        <svg viewBox="0 0 24 24" width="34" height="34" fill="none" stroke="#f7901e" stroke-width="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><path d="m9 12 2 2 4-4"/></svg>
        Ataevler <span style="color:#f7901e">Hurda Metal</span>
      </span>
    </a>
    <ul class="menu">
    ...
    <div class="f-grid">
      <div>
        <span style="display:flex;align-items:center;gap:10px;font-weight:800;font-size:1.15rem;color:#fff">
          <svg viewBox="0 0 24 24" width="30" height="30" fill="none" stroke="#f7901e" stroke-width="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><path d="m9 12 2 2 4-4"/></svg>
          Ataevler <span style="color:#f7901e">Hurda Metal</span>
        </span>
